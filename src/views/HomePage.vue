        ...
        <b-card>
          <b-card-body>
            <b-card-title
              >สถานะ:
              {{
                this.student && this.student.length > 3 ? this.student[4] : ""
              }}</b-card-title
            >
            <b-card-text
              >วันเวลา:
              {{
                this.student && this.student.length > 2 ? this.student[3] : ""
              }}</b-card-text
            >
            <hr />
            <b-card-text
              >ชื่อ:
              {{
                this.student && this.student.length > 1 ? this.student[2] : ""
              }}</b-card-text
            >
            <b-card-text
              >รหัสนักศึกษา:
              {{
                this.student && this.student.length > 0 ? this.student[1] : ""
              }}</b-card-text
            >
          </b-card-body>
        </b-card>
